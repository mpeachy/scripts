...
(: This query runs over a directory of EADs and produces an XML report listing unit id, unit title, scope notes, and subject headings at any level within the EADs that contain language matching a specified set of descriptive terms and variants (using regex). :)
...
<results>
    {
        ...
        return
            <item>
                ...
                <scopenote>{$match/child::ead:scopecontent/ead:p}</scopenote>
